...
const pairs = [
  ...
  { name: "Gold border on white (hamburger/CTA frame)", fg: APPROVED.gold, bg: WHITE, min: 3.0 },
  { name: "Gold border on teal (CTA frame)", fg: APPROVED.gold, bg: APPROVED.teal, min: 3.0 },
];
