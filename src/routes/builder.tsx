  ...
  head: () => ({
    meta: [
      { title: "YES Experience Studio — Design Your Portugal Experience" },
      {
        name: "description",
        content:
          "Start your way. We'll guide you as you build — shaping your private Portugal experience within what works best on the ground. Pay securely online when your journey is ready.",
      },
        ...
        <div className="container-x">
          <div className="text-center">
            ...
            <p className="mt-2 text-[10px] uppercase tracking-[0.28em] text-[color:var(--gold)]">
              Pay securely online when your journey is ready
            </p>
          </div>
  ...
  return (
    <div>
      ...
      <div className="mt-6 space-y-2.5">
        ...
        >
          Confirm & Pay Securely <ArrowRight size={13} />
        </Link>
        <p className="text-center text-[11px] text-[color:var(--charcoal-soft)] italic -mt-0.5">
          Secure online payment · Email confirmation within hours.
        </p>
        <button
          onClick={() => {
  ...
  return (
    <div className="bg-[color:var(--card)] border border-[color:var(--border)] p-5 rounded-sm">
      ...
      <p className="mt-2 text-[12px] text-[color:var(--charcoal-soft)] italic">
        Private guide, real route, curated stops included. Pay securely online — your local confirms pickup details by email within hours.
      </p>
    </div>
  );
}
