      ...
      >
        ...
        <div className="container-x relative z-10 pb-8 md:pb-36 pt-16 md:pt-40">
          <div className="max-w-2xl md:max-w-3xl text-[color:var(--ivory)]">
            ...
            <div className="hero-rhythm-microcopy-to-signature mb-2 md:mb-2 mt-5 md:mt-10 flex justify-center opacity-0 animate-[heroFade_0.9s_ease-out_1.05s_forwards]">
              <div
