        ...
        <div className="container-x relative z-10 pb-24 md:pb-36 pt-32 md:pt-40">
          <div className="max-w-3xl text-[color:var(--ivory)]">
            ...
            <span
              ...
              className="inline-flex items-center gap-2.5 sm:gap-3.5 whitespace-nowrap text-[9.75px] sm:text-[11.5px] md:text-[12.25px] uppercase tracking-[0.14em] sm:tracking-[0.26em] md:tracking-[0.3em] text-[color:var(--gold-soft)] opacity-0 animate-[heroFade_1.1s_ease-out_0.3s_forwards]"
            >
